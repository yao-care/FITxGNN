...
Ezetimibe is currently **not marketed in Finland** according to this Evidence Pack — 0 marketing authorizations are on file (`taiwan_regulatory.total_licenses = 0`, `market_status = Not marketed`). No Fimea license records are available to summarize.
