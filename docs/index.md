...
# Drug Repurposing Predictions — Finland

This project uses the TxGNN knowledge graph to predict potential new therapeutic uses for medicines approved in Finland.
