...
import pandas as pd
from fitxgnn.collectors import DrugBundleAggregator
from fitxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from fitxgnn.collectors.drug_bundle import PredictedIndication
    from fitxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from fitxgnn.collectors.drug_bundle import DrugBundle
