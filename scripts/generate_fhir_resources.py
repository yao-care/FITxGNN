...
BASE_URL = "https://fitxgnn.yao.care"
...
def generate_capability_statement() -> dict:
    ...
    return {
        ...
        "id": "fitxgnn-fhir-server",
        "url": f"{BASE_URL}/fhir/metadata",
        "version": "1.0.0",
        "name": "FITxGNNFHIRServer",
        "title": "FITxGNN FHIR Server - Finland Drug Repurposing",
        "description": "FHIR R4 server for Finland TxGNN drug repurposing predictions",
        "status": "active",
